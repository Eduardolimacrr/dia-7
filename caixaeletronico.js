...
do { 
    ...
    const valor = Number(prompt ('Digite o valor da transacao: '));
    const operacao = prompt('Qual operacao deseja realizar? S/D')

    if (valor < 0) {
        console.log('Valor inválido. A transação nõo foi realizada.');
